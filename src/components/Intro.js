...
const Intro =(props)=>{
    ...
    return (
        <section style={{"opacity":`${1 - scrollPos/250}`}} id='intro' ref={el=>{
            ...
            <img style={{"height": `${1 - scrollPos/250 <= 0 ? "0" : "105vh"}`}} className={`int-back`} id='intro-background' src='https://media-exp1.licdn.com/dms/image/C561BAQGEbvT3SFyR9Q/company-background_10000/0/1582050035728?e=2159024400&v=beta&t=xwPLRsVBBNXQQS3HN3q7hsYXmt6JxJsH6lpnbh9Y1ko' />
